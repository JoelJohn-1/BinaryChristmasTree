...
def Capture(total):
    ...
    directory = r'C:\Users\joelj\OneDrive\Desktop\BinaryChristmasTree\XYPics'
    os.chdir(directory)
    img_counter = 0
    integerLength = len(str(total))  
    #Delay until first movement is detected
    blackFrameS = 'C:/Users/joelj/OneDrive/Desktop/BinaryChristmasTree/XYPics/BlackFrame.png'
    ...
    while firstFrameNotFound:
        ...
        currentFrame = Image.open('C:/Users/joelj/OneDrive/Desktop/BinaryChristmasTree/XYPics/currentFrame.png')
        differentPixels = 0
        for x in range (0, bfFrame.size[0], 10):
            ...
            for y in range(0, bfFrame.size[1], 10):
                ...
                if (differentPixels > 2):
                    ...
                    break
        directory = r'C:/Users/joelj/Desktop/BinaryChristmasTree/XYPics'
        os.remove('C:/Users/joelj/OneDrive/Desktop/BinaryChristmasTree/XYPics/currentFrame.png')
